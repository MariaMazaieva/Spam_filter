...
class EmailAnalysis:
    def __init__(self, name, body, status = None):
        ...
        self.ham_words = Counter({
            "hello", "regards", "thank you", "please", "meeting", "discussion", "schedule",
            "agenda", "team", "project", "feedback", "details", "attached"
        })
    ...
    def count_probability(self):
        """
        Updates spam and ham probabilities based on various heuristic features.
        """
    ...
    def count_special_characters(self):
        """
        Counts occurrences of specific special characters (?, !, -) in the email body.
        """
    ...
    def find_suspicious_phrases(self):
        ...
        for phrase in suspicious_phrases:
            if phrase in body_lower:
                ...
                self.spam_possibility += 40  # Increase spam possibility for each detected phrase
